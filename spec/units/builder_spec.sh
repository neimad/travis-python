...
Describe "__install_builder()"
    ...
    It "installs the builder to the specified directory"
        ...
        The line 2 of entire output should equal "> Installing python-build..."
        The line 3 of entire output should equal "  requested location: $directory"
        The line 4 of entire output should equal "  installed version: 20200110"
        The line 5 of entire output should equal "  Done."
...
Describe "__available_python_versions_from_builder()"
    ...
    It "filters the ouput of the python-build command"
        ...
        The line 5 of entire output should equal "3.8.0-dev"
        The line 6 of entire output should equal "3.8.1"
        The line 7 of entire output should equal "activepython-3.7.0"
        The line 8 of entire output should equal "anaconda-4.0.0"
